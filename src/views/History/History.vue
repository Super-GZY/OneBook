<template>
  <div class="history">
    ...
    <van-button icon="brush-o" type="primary" style="position:fixed;top:50%;right:5%;z-index:1;border:none;border-radius:50%;font-size:15px" color="#f26552" @click="clear"/>
